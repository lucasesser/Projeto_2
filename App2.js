...
export default function App() {
  ...
  const buscarCep = () => {
    ...
    fetch(`https://viacep.com.br/ws/${cep.replace("-", "")}/json`)
      ...
      .then(
        fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${endereco.logradouro}%20${endereco.bairro}%20${endereco.localidade}&key=AIzaSyC7_wOMsigz1kkt-XFuRMJ4FseAWH82Lsk`)
        .then(resposta => resposta.json())
        .then(obj => {
          setCoord(obj)
          setErro("")
...
//  return Linking.openURL('maps://app?daddr=-12.551215+-55.733780')      google.navigation:q=${lat}+${long}
